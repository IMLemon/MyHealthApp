...
@interface MyHealthAppObject : KrollCoverageObject {
#else
@interface MyHealthAppObject : KrollObject {
#endif
@private
...
extern NSString * MyHealthApp$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	MyHealthAppObject *_myhealthapp;
    KrollObject* console;
	BOOL shutdown;
