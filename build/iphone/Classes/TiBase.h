...
// in simulator we redefine to format for MyHealthApp Developer console
...
{\
	NSString * exceptionName = [@"org.myhealthapp." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.myhealthapp";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIMyHealthAppNativeItemNone = -1, 
	UIMyHealthAppNativeItemSpinner = -2,
	UIMyHealthAppNativeItemProgressBar = -3,
	
	UIMyHealthAppNativeItemSlider = -4,
	UIMyHealthAppNativeItemSwitch = -5,
	UIMyHealthAppNativeItemMultiButton = -6,
	UIMyHealthAppNativeItemSegmented = -7,
	
	UIMyHealthAppNativeItemTextView = -8,
	UIMyHealthAppNativeItemTextField = -9,
	UIMyHealthAppNativeItemSearchBar = -10,
	
	UIMyHealthAppNativeItemPicker = -11,
	UIMyHealthAppNativeItemDatePicker = -12,
	
	UIMyHealthAppNativeItemInfoLight = -13,
	UIMyHealthAppNativeItemInfoDark = -14,
	
	UIMyHealthAppNativeItemDisclosure = -15,
	
	UIMyHealthAppNativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all MyHealthApp instances of
