...
//@interface MyHealthAppObject : NSObject
//@end

@interface MyHealthAppObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[MyHealthAppObject class]])
		{
			for (NSString *key in [[(MyHealthAppObject*)o modules] allKeys])
			{
